...
#define FILL_5(instance, A, B, C, D, E, ...)\
{                                    		\
    instance.A = A;             			\
    instance.B = B;             			\
    instance.C = C;             			\
...
#define FILL_4(instance, A, B, C, D, ...)   \
{                                    		\
    instance.A = A;             			\
    instance.B = B;             			\
    instance.C = C;             			\
...
#define FILL_2(instance, A, B, ...)   		\
{                                    		\
    instance.A = A;             			\
    instance.B = B;             			\
}

#define FILL_1(instance, A, ...)   			\
{                                    		\
    instance.A = A;             			\
}

#define GET_MACRO(_0,_1,_2,_3,_4,_5,NAME,...) NAME
#define BPF_CGROUP_LSM_CTX_INIT(instance,...) \
  GET_MACRO(_0,__VA_ARGS__,FILL_5,FILL_4,FILL_3,FILL_2,FILL_1,FILL_0)(instance,__VA_ARGS__)

/* For every LSM hook that allows attachment of BPF programs, declare a cgroup
 * run filter function.
 */
#define LSM_HOOK(RET, DEFAULT, NAME, ...)				\
	int __cgroup_bpf_run_filter_lsm_##NAME(__VA_ARGS__)	\
{														\
...
EXPORT_SYMBOL(__cgroup_bpf_run_filter_lsm_##NAME);
